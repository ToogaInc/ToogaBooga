...
export namespace VerifyManager {
    ...
    async function forcedManualVerify(
        ...
        const descSb = new StringBuilder()
            ...
            .append(`- Discord Created: ${TimeUtilities.getDiscordTime({ time: instance.member.user.createdTimestamp, style: TimeUtilities.TimestampType.FullDateNoDay })}`)
            .appendLine()
            .appendLine()
    ...
    async function handleManualVerification(
        ...
        const descSb = new StringBuilder()
            ...
            .append(`- Discord Mention: ${instance.member} (${instance.member.id})`).appendLine()
            .append(`- Discord Tag: ${instance.member.user.tag}`).appendLine()
            .append(`- Discord Created: ${TimeUtilities.getDiscordTime({ time: instance.member.user.createdTimestamp, style: TimeUtilities.TimestampType.FullDateNoDay })}`).appendLine()
            .appendLine()
            .append("__**RotMG Account**__").appendLine()
